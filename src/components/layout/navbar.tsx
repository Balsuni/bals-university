      ...
      >
        <ul className="w-screen lg:w-full absolute lg:relative flex items-center flex-col lg:flex-row pt-10 lg:pt-0 pb-20 lg:pb-0 gap-16 lg:gap-4 xl:gap-16 mt-24 sm:mt-28 lg:mt-0 text-gray-50 lg:text-gray-900 bg-darkblue-500 lg:bg-gray-50">
          <div>
            ...
            {openAbout && (
              <main className="px-0 sm:px-5 py-4 w-screen lg:w-[1024px] bg-bodyBackground text-darkblue-500 absolute top-24 lg:top-20  -left-0 lg:-left-48 z-0">
          ...
          <div>
            <li
              className=" flex items-center gap-2 text-lg py-2 border-b-2 border-darkblue-500 lg:border-bodyBackground hover:border-white lg:hover:border-darkblue-500 z-0"
            ...
            {openFeatures && (
              <main className="px-5 py-4 w-screen lg:w-[1024px] bg-bodyBackground text-darkblue-500 absolute top-[315px] lg:top-20  -left-0 lg:-left-48 z-0">
                <div className="py-3 px-5 sm:px-10 text-gray-900 font-normal text-lg border-b-[2px] border-gray-400 ">
                  Overview
                </div>
                <section className="text-[16px] py-5 px-5 sm:px-10 gap-8 grid grid-cols-2 grid-rows-2 pt-2 ">
