  ...
  return (
    <FooterWrapper>
      ...
      <div className="lg:ml-10 xl:ml-10 text-gray-50">
        <Image className="mt-auto mb-auto text-cyan1-500" src='/assets/logo.svg' alt="Logo" width={150} height={150} />
        ...
        <button type="submit" className="bg-cyan1-500 px-7 py-1 rounded-lg text-gray-100">Submit</button>
        </form>
      </div>
      ...
      <div className="mr-10 mt-16 lg:mt-0 xl:mt-0 text-gray-50">
        ...
        <div className="mt-24 grid grid-cols-1 gap-8 lg:grid-cols-2 xl:grid-cols-4 lg:gap-5 xl:gap-2">
          ...
          <FooterLinks>
            ...
            <li><Link href='/'>Skill Acquisition</Link></li>
          ...
          <FooterLinks>
            ...
            <li><Link href='/'>+ 234 (0) 234 234 234</Link></li>
            <li><Link href='/'>info@bals.ng</Link></li>
          </FooterLinks>
        </div>
      ...
      <div className="border-cyan2-500 border-t-2 w-screen mt-24 pb-1 text-gray-50">
        <p className="mt-5 ml-5 text-sm mr-5 font-bold">&copy; 2023 BALS UNIVERSITY 2023. All Right reserved</p>
      </div>
    </FooterWrapper>
  );
};
