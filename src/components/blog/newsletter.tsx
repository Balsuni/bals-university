...
const Newsletter = () => {
  return (
    <section className="flex flex-col items-center justify-center bg-bodyBackground pt-5 pb-10 md:pb-14 ">
      <img
        className="bg-darkblue-500 rounded-[50px] sm:rounded-[64px] h-[300px] sm:h-[350px] md:h-[400px] w-[300px] sm:w-[600px] md:w-[700px] lg:w-[800px] xl:w-auto  "
        src="/assets/path.svg"
        alt="path"
      />
      <div className="absolute flex flex-col items-center gap-8">
        ...
        <form className="flex w-[280px]   ">
          <input
            type="text"
            className="w-10/12 px-5 h-12 rounded-lg  bg-darkblue-300 font-light"
