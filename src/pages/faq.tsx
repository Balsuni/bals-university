...
const FAQ = () => {
  ...
  return (
    ...
    <Layout>
      ...
      <img src="/assets/letter_send 2.svg" className="absolute left-[500px] top-[310px] w-[450px]" alt="" />
      </div>
      ...
      {faqData.map((data) => {
              ...
              <p className="text-darkblue-800 font-bold tracking-normal text-md lg:text-lg pr-3">{data.title}
               ...
               <img src="/assets/faqplusicon.svg" className="py-4 px-5 mr-5 ml-auto sm:ml-10" alt="" />
              </div>
      ...
      {/* <div className="justify-center w-fit ml-auto mr-auto px-3 py-10 pb-10 mt-20 mb-20">
      ...
      {secondFaqData.map((data) => {
              return <div className="flex flex-col gap-5 lg:gap-7 w-fit sm:w-fit md:w-9/12 xl:w-8/12 bg-gray-50 p-5 py-10 md:px-12 ml-5 mr-5 rounded-3xl shadow-md shadow-gray-500" key={data.id}> 
          ...
          <div className="flex w-full flex-col gap-0 mt-16 ml-auto mr-auto items-center">
            {faqData.map((data) => {
              return <div className="flex flex-col gap-5 lg:gap-5 w-fit sm:w-fit md:w-9/12 xl:w-9/12 p-5 py-10 md:px-12 ml-5 mr-5" key={data.id}> 
              <div className="flex w-fit sm:w-9/12 md:w-11/12 lg:w-11/12 gap-5 lg:gap-14 flex-row bg-gray-200 p-5 md:px-10 shadow-md shadow-gray-500 ml-auto mr-auto">
               <p className="font-semibold text-md">{data.title}</p>
               <img src="/assets/plusicon.svg" className="ml-5 sm:ml-10" alt="" />
              </div>
              <div className="w-fit sm:w-9/12 md:w-11/12 lg:w-11/12 ml-3 mr-3 sm:ml-auto sm:mr-auto break-words md:ml-auto md:mr-auto mt-3">
