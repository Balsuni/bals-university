    ...
    <Layout>
      <div className="hidden lg:inline">
        <img
          ...
          className="absolute left-[200px] top-[310px] w-[450px]"
          alt=""
        />
      </div>
      ...
      <main className="w-full pt-12 sm:py-14 md:py-14 lg:py-16 xl:py-20 bg-bodyBackground">
        <div>
          <h5 className="text-darkblue-500 font-semibold text-[26px] md:text-[26px] xl:text-[26px] lg:text-[26px] mt-10 lg:mt-40 tracking-wider text-center ml-5 mr-5">
