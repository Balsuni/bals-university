  ...
  return (
    <Layout>
      <div className="hidden lg:inline">
        <img
          src="/assets/letter_send 2.svg"
          className="absolute left-[500px] top-[310px] w-[450px]"
          alt=""
        />
      </div>
        ...
        <div className="pb-20">
          ...
          <div className="flex w-full flex-col gap-10 mt-16 ml-auto mr-auto items-center">
            {secondFaqData.map((data) => {
              return (
                <div
                  className="flex flex-col gap-5 lg:gap-7 w-11/12 sm:w-8/12 md:w-9/12 xl:w-8/12 bg-gray-50 p-5 py-10 md:px-12 ml-2 mr-2 rounded-3xl shadow-md shadow-gray-500"
                  key={data.id}
                >
                  <div className="flex flex-row items-center justify-between w-full">
                    <p className="w-fit text-darkblue-800 font-bold tracking-normal text-md lg:text-lg pr-3 break-normal">
                      {data.title}
                    </p>
                    <img
                      src="/assets/arrowside.svg"
                      className="bg-gray-100 shadow-xl py-4 px-2 sm:px-5 rounded-full mr-5 ml-auto sm:ml-10"
                      alt=""
                    />
                  </div>
