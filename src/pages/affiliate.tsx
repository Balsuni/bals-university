...
const affiliate = () => {
    ...
    const whatWeOffer = [
        {
            ...
            content: 'cu dignissim Lorem ipsum dolor sit amet  cu dignissim Lorem ipsum dolor sit amet  cu dignissim Lorem ipsum dolor sit amet cu dignissim Lorem ipsum dolor sit amet cu dignissim Lorem ipsum dolor sit amet cu dignissim Lorem ipsum dolor sit amet',
        },
        {
            id: 2,
  ...
  return (
    <Layout>
          ...
          <div className="flex flex-col lg:flex-row items-center px-0 md:px-10 lg:px-16 xl:px-20  py-0 md:py-5 lg:py-12 xl:py-10">
            ...
            <div className="w-full mb-28 h-fit flex flex-col gap-3 lg:flex-row sm:gap-0 sm:flex-row xl:mr-28 lg:mt-16">
              <div className="w-full flex flex-col lg:flex-col gap-5 px-5 md:px-0 ">
                <h1 className="font-bold text-2xl tracking-normal lg:text-3xl text-gray-50">Join our community of affiliates by promoting our high-quality courses and start earning extra Income</h1>
        ...
        <div className='mt-16'>
            <h1 className='w-fit ml-auto mr-auto text-darkblue-900 text-4xl text-center font-semibold'>What we Offer</h1>
                ...
                {whatWeOffer.map((offer) => (
                    <div className='w-fit mx-auto flex flex-col gap-2' key={offer.id}>
                        <div className='flex flex-col sm:flex-row sm:justify-normal items-center gap-5 sm:gap-20 sm:mx-0'>
                            <h1 className='w-[54px] h-[54px] flex items-center justify-center bg-cyan1-900 rounded-full text-gray-50 font-bold text-2xl'>{offer.id}</h1>
                            <h1 className='my-auto text-darkblue-900 text-[20px] font-semibold'>{offer.title}</h1>
                        </div>
        ...
        <div className='relative top-[150px] hidden xl:block'>
            <img src="/assets/pointer_shape(1).svg" className='absolute left-[250px]' alt="" />
        </div>

        <div className='relative top-[0px] left-[180px] hidden xl:block'>
            <img src="/assets/pointer_shape.svg" className='absolute left-[900px]' alt="" />
        </div>
        ...
        <section className="text-darkblue-900 flex flex-col lg:flex-row gap-5 items-center justify-between px-5 sm:px-12 md:px-14 lg:px-16 xl:px-16 ">
          <div className="sm:w-full px-0 sm:px-12 md:px-24 lg:px-3 lg:pl-5 py-12 bg-darkblue-50">
            ...
            learning, we understand , can be challenging, but rest assured that we are here to support you every step of the way. Our courses r
            </h3>
            <button
